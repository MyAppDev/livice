    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="http://getbootstrap.com/2.3.2/examples/fluid.html#">Project name</a>
          <div class="nav-collapse collapse">
            <p class="navbar-text pull-right">
              Logged in as <a href="http://getbootstrap.com/2.3.2/examples/fluid.html#" class="navbar-link">Username</a>
            </p>
            <ul class="nav">
              <li class="active"><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#">Home</a></li>
              <li><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#about">About</a></li>
              <li><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#contact">Contact</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#">Link</a></li>
              <li><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#">Link</a></li>
              <li><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#">Link</a></li>
              <li><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#">Link</a></li>
              <li class="nav-header">Sidebar</li>
              <li><a href="http://getbootstrap.com/2.3.2/examples/fluid.html#">Link</a></li>
        ...
        <div class="span9">
          ...
          <div class="row-fluid">
            <div class="span4">
              ...
              <p><a class="btn" href="http://getbootstrap.com/2.3.2/examples/fluid.html#">View details »</a></p>
            </div><!--/span-->
            <div class="span4">
              <h2>Heading</h2>
              <p>Donec id elit non mi porta gravida at eget metus. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Etiam porta sem malesuada magna mollis euismod. Donec sed odio dui. </p>
