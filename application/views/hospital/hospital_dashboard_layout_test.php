		    ...
		    <div id="wrapper">
		        ...
		        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
		            <div class="navbar-header">
		                ...
		                <a class="navbar-brand" href="<?= base_url(); ?>assets/index.html" style="font-size:35px; padding-top:8px;">LIVICE <p style="font-size:20px; padding-top:2px;">-living innovation device-</p></a>
		            </div>
		            <!-- /.navbar-header -->
		            ...
		            <div class="navbar-default sidebar" role="navigation">
		                <div class="sidebar-nav navbar-collapse">
		                    <ul class="nav" id="side-menu">
		                        <li>
		                            <a href="<?= base_url(); ?>assets/pages/index.html"><i class="fa fa-dashboard fa-fw"></i>患者リスト</a>
		                        </li>
